...
class Entree(db.Model):
    ...
    nom_famille_entree = db.Column(db.String( 255), nullable=False)
    ...
    ingredients = db.relationship(
        "Ciqual", secondary=IngredientsEntree, lazy="subquery"

    )

    @classmethod
    def find_by_id(cls, _id) -> "Entree":
        return cls.query.filter_by(id=_id).first()

    @classmethod
    def find_all(cls, page, per_page) -> List["Entree"]:
